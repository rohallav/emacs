;;; ~/tod/.doom.d/doom-sourcerer-personal-theme.el -*- lexical-binding: t; -*-
;;; Commentary:
(require 'doom-themes)
;;; Code:
;;
(defgroup doom-sourcerer-personal-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-sourcerer-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-sourcerer-personal-theme
  :type 'boolean)
...
;;
(def-doom-theme doom-sourcerer-personal
...
;;; doom-sourcerer-personal-theme.el ends here
